						...
						<View className={"flex-row gap-8"}>
							<View className={"w-full gap-4"}>
								...
								<View>
									<View
										className={
											"native:h-12 native:text-lg native:leading-tight h-10 flex-row items-center rounded-md border border-input bg-background px-3 text-base text-foreground file:border-0 file:bg-transparent file:font-medium lg:text-sm"
										}
									>
										<Input
											style={{ flex: 1 }}
								...
								<View>
									<Button
										onPress={() =>
											void handleUpdate("name", community.name ?? "")
										}
										disabled={isDisabled}
									>
										<Text>Save</Text>
