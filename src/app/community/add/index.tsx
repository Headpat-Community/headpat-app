...
import { ExecutionMethod, type Models } from "react-native-appwrite";
...
import type { HeadpatException } from "~/lib/types/collections";
		...
		>
			<ScrollView>
				<View className={"mx-8 flex-1"}>
					<View className={"flex-1"}>
						...
						{page === 2 && (
							<View className={"gap-4 py-8"}>
								<View>
									<Label nativeID={"isPrivate"}>Is community private?</Label>
									<Checkbox
										nativeID={"isPrivate"}
										className={"p-4"}
					...
					<View style={{ marginBottom: 40 }} className={"mt-8 gap-4"}>
						{page === 1 && (
