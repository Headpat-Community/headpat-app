  ...
  const fetchGallery = useCallback(
    async (page = 1, append = false) => {
      try {
        ...
        const query = [Query.limit(pageSize), Query.offset(offset), Query.orderDesc('$createdAt')]
        ...
        const parsedImagePrefs = imagePrefsData.rows.reduce(
          (acc: Record<string, GalleryPrefsDocumentsType>, pref: GalleryPrefsDocumentsType) => {
        ...
        setImagePrefs(parsedImagePrefs as Record<string, GalleryPrefsDocumentsType>)
    ...
    [current, showAlert, generateThumbnail],
  )
