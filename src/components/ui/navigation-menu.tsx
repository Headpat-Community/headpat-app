  ...
  return (
    <View className={cn('absolute left-0 top-full flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        className={cn(
          'web:origin-top-center relative mt-1.5 w-full overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-lg web:h-(--radix-navigation-menu-viewport-height) web:animate-in web:zoom-in-90',
          className,
        )}
        ref={ref}
        {...props}
