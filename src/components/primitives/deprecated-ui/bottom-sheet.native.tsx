  ...
  ({ className, ...props }, ref) => {
    return (
      <GBottomSheetTextInput
        ref={ref}
        className={cn(
          'h-14 items-center rounded-md border border-input bg-background px-3 text-xl leading-tight text-foreground placeholder:text-muted-foreground disabled:opacity-50',
          className,
        )}
        {...props}
      />
