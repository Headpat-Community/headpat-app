...
export default function RelationshipList({ type, title, emptyMessage }: RelationshipListProps) {
  ...
  const keyExtractor = useCallback((item: UserDataDocumentsType) => item.$id, [])
