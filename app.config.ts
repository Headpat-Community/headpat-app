...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  plugins: [
    ...
    [
      'expo-location',
      {
        locationAlwaysAndWhenInUsePermission: 'Allow Headpat to share your location with other users so they can see you on the map.',
        locationAlwaysPermission: 'Allow Headpat to share your location with other users so they can see you on the map.',
    ...
    [
      'expo-image-picker',
      {
        photosPermission: 'The app accesses your photos to let you share them with your fellow friends.'
      }
    ],
    [
      'expo-sqlite',
